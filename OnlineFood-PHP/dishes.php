...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="container product-data m-t-30">
                <div class="row">
									...
									<?php echo $item["title"]; ?><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?> " >
                                        ...
                                        <div class="form-group row no-gutter">
                                            <div class="col-xs-8">
                                                ...
                                                <input type="text" class="form-control " value=<?php echo "TK".$item["price"]; ?> readonly id="animsition">
                                            ...
                                            <div class="col-xs-4">
                                               ...
                                               <input type="text" class="form-control text-center input-qty bg-white" readonly value='<?php echo $item["quantity"]; ?> ' id="example-number-input"> 
									...
									foreach($products as $product)
										{
													 ...
													 ?>
                                <div class="food-item product_data">
                                    <div class="row">
                                        ...
                                        <div class="input-group mb-3">
										 <input class="b-r-0 input-qty" type="text" name="quantity"  style="margin-left:30px;" value="1" size="2" />
